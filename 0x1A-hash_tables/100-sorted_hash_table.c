...
/**
 * shash_create - function to create a sorted hash table
 * @size: Array size
...
/**
 * shash_set - add an element at the sorted hash table
 * @ht: The sorted hash table
 * @key: Type const char pointer of the key
 * @value: Key value
 * Return: 0 if fail or 1 otherwise
 */
...
/**
 * shash_get - function to get a value in a sorted hash table
...
/**
 * shash_print - fucntion to print a sorted hash table
...
/**
 * shash_print_rev - function to print a sorted hash table in reverse
 * @ht: sorted hash_table
 */
...
/**
 * shash_delete - function to delete a sorted hash table
 * @ht: sorted hash_tabe
 */
